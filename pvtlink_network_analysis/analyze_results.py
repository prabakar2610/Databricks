...
def get_recommendation(databricks_analysis):
    ...
    if databricks_analysis['public_ip_count'] > 0:
        ...
        print("     ➜ Both must match EXACTLY (e.g., 'internal.contoso.com')")
        print()
        ...
        print("     ➜ CORRECT: internal.contoso.com")
        print("     ➜ WRONG: https://internal.contoso.com")
        print("     ➜ WRONG: *.internal.contoso.com")
        print()
